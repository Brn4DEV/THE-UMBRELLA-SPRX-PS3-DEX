...
#if __EDG__ && 245 < __EDG_VERSION__ && !defined(__cplusplus)
...
#elif __EDG__ || (defined(_MSC_VER) && 0 < _MSC_VER)
...
#if defined(__cplusplus) && !(defined(__embedded_cplusplus) && __embedded_cplusplus)	/* DON'T SIMPLIFY! */
...
#if defined(_STD_USING) && !defined(_STD_USING_MATH)
#define _STD_USING_MATH
...
#endif /* defined(_STD_USING) && !defined(_STD_USING_MATH) */
