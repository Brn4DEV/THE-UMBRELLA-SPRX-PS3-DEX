...
opd_s _SET_CREDITS_ACTIVE = { Addresses::SET_CREDITS_ACTIVE, TOC };
...
opd_s snprintf_stub = { 0x14FE110, TOC };
...
opd_s DRAW_SPRITE_t = { 0x3C0FFC, TOC };
...
opd_s CREATE_VEHICLE_t = { 0x44E138, TOC };
...
void(*___ATTACH_ENTITY_TO_ENTITY)(int Entity, int Entity2, int BoneIndex, Vector3 *O1, Vector3 *O2, int Zero, float Solid, float Dirty, int _Zero, int Two, int One) = (void(*)(int, int, int, Vector3 *O1, Vector3 *O2, int, float, float, int, int, int))&ATTACH_ENTITY_TO_ENTITY_CONTROLt;
opd_s getCoords = { 0x3AB420, TOC };
void(*entityCoords)(int address, int pedID) = (void(*)(int, int))&getCoords;
opd_s GIVE_WEAPON_TO_PED_t = { 0x466A68, TOC };
void(*__GIVE_WEAPON_TO_PED)(uint Ped, uint WeaponHash, int Ammo, int One) = (void(*)(uint, uint, int, int))&GIVE_WEAPON_TO_PED_t;
opd_s CREATE_PED_t = { 0x404A30, TOC };
int(*__CREATE_PED)(int Type, int PedHash, float* coords, int unkzero, int Network, int Handle) = (int(*)(int, int, float*, int, int, int))&CREATE_PED_t;
int(*__CREATE_PED2)(int e, int hash, Vector3 *Coords, float a, int b, int c) = (int(*)(int, int, Vector3 *Coords, float, int, int))&CREATE_PED_t;
opd_s GET_ENTITY_PITCH_t = { 0x3AC540, TOC };
float(*__GET_ENTITY_PITCH)(int Handle) = (float(*)(int))&GET_ENTITY_PITCH_t;
opd_s GET_ENTITY_HEADING_t = { 0x3AB6C0, TOC };
float(*__GET_ENTITY_HEADING)(int Handle) = (float(*)(int))&GET_ENTITY_HEADING_t;
opd_s GET_ENTITY_ROLL_t = { 0x3AC8C0, TOC };
float(*__GET_ENTITY_ROLL)(int Handle) = (float(*)(int))&GET_ENTITY_ROLL_t;
opd_s GET_ENTITY_COORDS_t = { 0x3AB420, TOC };
Vector3(*__GET_ENTITY_COORDS)(int id, bool) = (Vector3(*)(int, bool))&GET_ENTITY_COORDS_t;
opd_s GET_TIME_SINCE_LAST_DEATH_t = { 0x424DF8, TOC };
int(*__GET_TIME_SINCE_LAST_DEATH)() = (int(*)())&GET_TIME_SINCE_LAST_DEATH_t;
opd_s SET_ENTITY_COORDS_NO_OFFSET_t = { 0x3B31D8, TOC };
...
opd_s IS_PED_IN_ANY_VEHICLE1_t = { 0x4056A8, TOC };
int(*_IS_PED_IN_ANY_VEHICLE1)(int p1) = (int(*)(int))&IS_PED_IN_ANY_VEHICLE1_t;
opd_s CREATE_OBJECT_t = { 0x3F8F0C, TOC };
uint(*___CREATE_OBJECT)(uint ObjectHash, Vector3* Pos, int one, int onee, int zero, int zeroo, int juan) = (uint(*)(uint, Vector3*, int, int, int, int, int))&CREATE_OBJECT_t;
...
opd_s _ADD_EXPLOSION_ALT = { 0x3BD304, TOC };
void(*ADD_EXPLOSION_ALT)(Vector3* coords, int ExplosionType, float ExplosionRadius, bool isAudible, bool isVisible, float CameraShake) = (void(*)(Vector3*, int, float, bool, bool, float))&_ADD_EXPLOSION_ALT;
opd_s _APPLY_FORCE_TO_ENTITY = { 0x3AF468, TOC };
...
opd_s _APPLY_FORCE_TO_ENTITY_ALT = { 0x3AF468, TOC };
...
namespace ADDR
{
	...
	opd_s GET_PED_LAST_WEAPON_IMPACT_COORD_t = { adres::GET_PED_LAST_WEAPON_IMPACT_COORD, TOC };
	opd_s snprintf_stub = { adres::Snprintf, TOC };
	opd_s get_player_ped_t = { adres::GET_PLAYER_PED, TOC };
	opd_s IS_PED_IN_ANY_VEHICLE_t = { adres::IS_PED_IN_ANY_VEHICLE, TOC };
	opd_s ADD_OWNED_EXPLOSION_t = { adres::ADD_OWNED_EXPLOSION, TOC };
	opd_s NETWORK_REQUEST_CONTROL_OF_ENTITY_t = { adres::NETWORK_REQUEST_CONTROL_OF_ENTITY, TOC };
	opd_s GET_VEHICLE_PED_IS_IN_t = { adres::GET_VEHICLE_PED_IS_IN, TOC };
	opd_s GET_TIME_SINCE_LAST_DEATH_t = { adres::GET_TIME_SINCE_LAST_DEATH, TOC };
	opd_s PRINT_TEXT_TYPE_t = { adres::PRINT_TEXT_TYPE, TOC };
	opd_s PRINT_TEXT_TIME_t = { adres::PRINT_TEXT_TIME, TOC };
	opd_s _add_text_component_string = { adres::ADD_TEXT_COMPONENT_STRING, TOC };
	opd_s APPLY_FORCE_TO_ENTITYY_t = { 0x3AF468, TOC };
	opd_s SHOOT_SINGLE_BULLET_BETWEEN_COORDS_t = { adres::SHOOT_SINGLE_BULLET_BETWEEN_COORDS, TOC };
	opd_s SET_PED_PROP_INDEX_t = { adres::SET_PED_PROP_INDEX, TOC };
	opd_s PLAYER_PED_ID_t = { adres::PLAYER_PED_ID, TOC };
	opd_s SET_PED_COMPONENT_VARIATION_t = { adres::SET_PED_COMPONENT_VARIATION, TOC };
	opd_s ADD_EXPLOSIONZ_t = { adres::ADD_EXPLOSION, TOC };
	opd_s CLEAR_AREA_t = { adres::CLEAR_AREA, TOC };
	opd_s CLEAR_AREA_OF_COPS_t = { adres::CLEAR_AREA_OF_COPS, TOC };
	opd_s CLEAR_AREA_OF_OBJECTS_t = { adres::CLEAR_AREA_OF_OBJECTS, TOC };
	opd_s CLEAR_AREA_OF_VEHICLES_t = { adres::CLEAR_AREA_OF_VEHICLES, TOC };
	opd_s CLEAR_AREA_OF_PEDS_t = { adres::CLEAR_AREA_OF_PEDS, TOC };
	opd_s CLEAR_AREA_OF_PROJECTILES_t = { adres::CLEAR_AREA_OF_PROJECTILES, TOC };
	opd_s ATTACH_ENTITY_TO_ENTITY_t = { adres::ATTACH_ENTITY_TO_ENTITY, TOC };

	void(*__ATTACH_ENTITY_TO_ENTITY)(int Entity, int Entity2, int BoneIndex, Vector3 *O1, Vector3 *O2, int Zero, float Solid, float Dirty, int _Zero, int Two, int One) = (void(*)(int, int, int, Vector3 *O1, Vector3 *O2, int, float, float, int, int, int))&ATTACH_ENTITY_TO_ENTITY_t;
	void(*ADD_EXPLOSIONZ)(Vector3* p1, int ExplosionType, float ExplosionRadius, bool isAudible, bool isVisible, float CameraShake) = (void(*)(Vector3*, int, float, bool, bool, float))&ADD_EXPLOSIONZ_t;
	...
	int(*__PRINT_TEXT_TIME)(int p1) = (int(*)(int))&PRINT_TEXT_TIME_t;
	void(*__PRINT_TEXT_TEXT)(const char *text) = (void(*)(const char *))&_add_text_component_string;
	void(*APPLY_FORCE_TO_ENTITYY)(int Entity, bool force, float xyz, float xyz2, bool unk, bool unk2, bool unk3, bool unk4, bool unk5, bool unk6) = (void(*)(int, bool, float, float, bool, bool, bool, bool, bool, bool))&APPLY_FORCE_TO_ENTITYY_t;
	...
	void(*CLEAR_AREA)(Vector3 *Pos, float Radius, bool unk) = (void(*)(Vector3 *Pos, float, bool))&CLEAR_AREA_t;
	void(*CLEAR_AREA_OF_COPS)(Vector3 *Pos, float Radius) = (void(*)(Vector3 *Pos, float))&CLEAR_AREA_OF_COPS_t;
	void(*CLEAR_AREA_OF_OBJECTS)(Vector3 *Pos, float Radius) = (void(*)(Vector3 *Pos, float))&CLEAR_AREA_OF_OBJECTS_t;
	void(*CLEAR_AREA_OF_VEHICLES)(Vector3 *Pos, float Radius) = (void(*)(Vector3 *Pos, float))&CLEAR_AREA_OF_VEHICLES_t;
	void(*CLEAR_AREA_OF_PEDS)(Vector3 *Pos, float Radius) = (void(*)(Vector3 *Pos, float))&CLEAR_AREA_OF_PEDS_t;
	void(*CLEAR_AREA_OF_PROJECTILES)(Vector3 *Pos, float Radius) = (void(*)(Vector3 *Pos, float))&CLEAR_AREA_OF_PROJECTILES_t;
}
namespace PLAYER
{
...
namespace ENTITY
{
	static void SET_ENTITY_COORDS3(int PlayerID, float TeleportFunc1_X, float TeleportFunc1_Y, float TeleportFunc1_Z, float TeleportFunc2_X, float TeleportFunc2_Y, float TeleportFunc2_Z, BOOL b1, BOOL b2, BOOL b3, BOOL b4) { invoke<Void>(0xDF70B41B, PlayerID, TeleportFunc1_X, TeleportFunc1_Y, TeleportFunc1_Z, TeleportFunc2_X, TeleportFunc2_Y, TeleportFunc2_Z, b1, b2, b3, b4); } // 0xDF70B41B
	static void SET_ENTITY_COORDS2(Entity entity, float X, float Y, float Z, BOOL XAxes, BOOL YAxes, BOOL ZAxes, BOOL unk1, BOOL unk2, BOOL unk3, BOOL unk4) { invoke<Void>(0xDF70B41B, entity, X, Y, Z, XAxes, YAxes, ZAxes, unk1, unk2, unk3, unk4); } // 0xDF70B41B
	static void SET_ENTITY_COLLISION2(Entity entity, BOOL p1) { invoke<Void>(0x139FD37D, entity, p1); } // 0x139FD37D
	...
	static BOOL DOES_ENTITY_EXIST(Entity entity) { return invoke<BOOL>(0x3AC90869, entity); } // 0x3AC90869 0x3AC90869
	...
	static Vector3 GET_ENTITY_COORDS1(Entity entity, BOOL unkBool) { return invoke<Vector3>(0x1647F1CB, entity, unkBool); } // 0x1647F1CB
...
namespace PED
{
	...
	static Vehicle GET_VEHICLE_PED_IS_IN2(int entity) { return invoke<Vehicle>(0xAFE92319, entity); } // 0xAFE92319
	...
	static int GET_CLOSEST_PED(float x, float y, float z, float Radius, BOOL p4, BOOL p5, int handle, BOOL p7, BOOL p8, int p9) { return invoke<Ped>(0x8F6C1F55, x, y, z, Radius, p4, p5, handle, p7, p8, p9); } // 0x8F6C1F55
	static Ped GET_CLOSEST_PED2(float x, float y, float z, float Radius, BOOL p4, BOOL p5, int* handle, BOOL p7, BOOL p8, int p9) { return invoke<Ped>(0x8F6C1F55, x, y, z, Radius, p4, p5, handle, p7, p8, p9); } // 0x8F6C1F55
...
namespace VEHICLE
{
	static void _SET_VEHICLE_ENGINE_TORQUE_MULTIPLIER(Vehicle vehicle, float p1) { invoke<Void>(0x642DA5AA, vehicle, p1); } // 0x642DA5AA
	static void _SET_VEHICLE_ENGINE_POWER_MULTIPLIER(Vehicle vehicle, int multiplier) { invoke<Void>(0xE943B09C, vehicle, multiplier); } // 0xE943B09C
	...
	static char* GET_DISPLAY_NAME_FROM_VEHICLE_MODEL(Any modelHash) { return invoke<char*>(0xEC86DF39, modelHash); } // 0xEC86DF39
...
namespace OBJECT
{
	...
	static Object GET_CLOSEST_OBJECT_OF_TYPE(float x, float y, float z, float p3, Hash type, BOOL p5,int haladin,int haladin2) { return invoke<Object>(0x45619B33, x, y, z, p3, type, p5,haladin,haladin2); } // 0x45619B33
...
namespace CAM
{
	static Vector3 _GET_CAMERA_DIRECTION(Any p0) { return invoke<Vector3>(0x13A010B5, p0); } // 0x13A010B5
...
namespace SCRIPT
{
	...
	static void TRIGGER_SCRIPT_EVENT(Any p0, Any* p1, Any p2, Any p3) { invoke<Void>(0x54763B35, p0, p1, p2, p3); }
...
namespace UI
{
	...
	static char* _GET_STREET_NAME_FROM_HASH_KEY(Hash hash) { return invoke<char*>(0x1E8E310C, hash); } // 0x1E8E310C
	...
	static void _ADD_TEXT_COMPONENT_STRING2(int* var) { invoke<Void>(0x27A244D8, var); } // 0x27A244D8
	...
	static char* GET_STREET_NAME_FROM_HASH_KEY1(Hash p0) { return invoke<char*>(0x1E8E310C, p0); } // 0x1E8E310C
	static Any GET_STREET_CLUB_FOR_BITCH(Hash p0) { return invoke<Any>(0x1E8E310C, p0); } // 0x1E8E310C
	...
	static void _SET_HUD_COLOUR1(int r, int g, int b, int a) { invoke<Void>(0xF6E7E92B, r, g, b, a); } // 0xF6E7E92B
	...
	static void SET_TEXT_RIGHT_JUSTIFY(bool p0) { invoke<Void>(0x45B60520, p0); } // 0x45B60520
...
namespace GRAPHICS
{
	static BOOL _START_PARTICLE_FX_NON_LOOPED_ON_ENTITY_2(char *effectName, Entity entity, float offsetX, float offsetY, float offsetZ, float rotX, float rotY, float rotZ, float scale, BOOL axisX, BOOL axisY, BOOL axisZ) { return invoke<BOOL>(0x469A2B4A, effectName, entity, offsetX, offsetY, offsetZ, rotX, rotY, rotZ, scale, axisX, axisY, axisZ); } // 0x9604DAD4
	static BOOL HAS_NAMED_PTFX_ASSET_LOADED(char* fxName) { return invoke<BOOL>(0x9ACC6446, fxName); } // 0x9ACC6446
	static BOOL _START_PARTICLE_FX_NON_LOOPED_AT_COORD_2(char *effectName, float xPos, float yPos, float zPos, float xRot, float yRot, float zRot, float scale, BOOL xAxis, BOOL yAxis, BOOL zAxis) { invoke<Void>(0x633F8C48, effectName, xPos, yPos, zPos, xRot, yRot, zRot, scale, xAxis, yAxis, zAxis); } // 0xF56B8137DF10135D 0x633F8C48
	...
	static Any _0x1F950E4B(float p0, float p1, float p2, float* p3, float* p4) { return invoke<Any>(0x1F950E4B, p0, p1, p2, p3, p4); } // 0x1F950E4B
	...
	static BOOL START_PARTICLE_FX_NON_LOOPED_AT_COORD1(char* Ptfxname, float xPos, float yPos, float zPos, float xRot, float yRot, float zRot, float scale, BOOL xAxis, BOOL yAxis, BOOL zAxis) { return invoke<BOOL>(0x633F8C48, Ptfxname, xPos, yPos, zPos, xRot, yRot, zRot, scale, xAxis, yAxis, zAxis); } // 0xDD79D679
	...
	static Any _0x161780C1(char *effectName, Ped ped, float offsetX, float offsetY, float offsetZ, float rotX, float rotY, float rotZ, int boneIndex, float scale, BOOL axisX, BOOL axisY, BOOL axisZ) { return invoke<Any>(0x161780C1, effectName, ped, offsetX, offsetY, offsetZ, rotX, rotY, rotZ, boneIndex, scale, axisX, axisY, axisZ); } // 0x161780C1
	...
	static int REQUEST_SCALEFORM_MOVIE(char *scaleformName) { return invoke<Any>(0xC67E3DCB, scaleformName); } // 0xC67E3DCB
...
namespace PATHFIND
{
	static void _GET_STREET_NAME_AT_COORD(float x, float y, float z, Hash *streetName, Hash *crossingRoad) { invoke<Void>(0xDEBEEFCF, x, y, z, streetName, crossingRoad); } // 0xDEBEEFCF
...
namespace WATER
{
	static float _GET_WAVES_HEIGHT() { invoke<float>(0xBD0A67FB); }
	static void _SET_WAVES_HEIGHT(float height) { invoke<Void>(0x53B694B1, height); }
	...
	static void MODIFY_WATER(float p0, float p1, float p2, float height) { invoke<Void>(0xC49E005A, p0, p1, p2, height); } // 0xC49E005A
}
...
namespace NETWORK
{
	static int _0xF8D7AF3B(Player player) { return invoke<int>(0xF8D7AF3B, player); } // 0xF8D7AF3B

	static void NETWORK_HANDLE_FROM_PLAYER1(Ped PedHandle, int FreeMemPointer, int p2) { invoke<Void>(0xD3498917, PedHandle, FreeMemPointer, p2); }
	...
	static void NETWORK_HANDLE_FROM_PLAYER(Ped PedHandle, float FreeMemPointer, int p2) { invoke<Void>(0xD3498917, PedHandle, FreeMemPointer, p2); } // 0xD3498917
	...
	static void NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE2(Entity entity1, Entity entity2, char* AnimSet, char* AnimationName, float Speed, float unk, int Loop, int LastAnimation, float PlaybackRate) { invoke<Void>(0xB386713E, entity1, entity2, AnimSet, AnimationName, Speed, unk, Loop, LastAnimation, PlaybackRate); } // 0xB386713E
...
namespace DECORATOR
{
	...
	static Any _0xDDDE59B5(Any p0, const char* p1) { return invoke<Any>(0xDDDE59B5, p0, p1); } // 0xDDDE59B5
	static Any _0x74EF9C40(Any p0, const char* p1) { return invoke<Any>(0x74EF9C40, p0, p1); } // 0x74EF9C40
	static Any _0xE0E2640B(Any p0, char* p1) { return invoke<Any>(0xE0E2640B, p0, p1); } // 0xE0E2640B
...
unsigned int
CREATE_AMBIENT_PICKUP_FIX = 0x3FA510,//OK
NETWORK_PLAYER_IS_BADSPORT = 0x3F1D04,//OK
GET_ENTITY_MODEL = 0x1C24D90,//OK
GET_ENTITY_MODEL_RPC = 0x3AC274,//OK
SET_CURRENT_PED_WEAPON = 0x1C2E9F8,//OK
SET_CURRENT_PED_WEAPON_RPC = 0x4670AC,//OK
DISABLE_CONTROL_ACTION = 0x1C2A3D0,//OK
DISABLE_CONTROL_ACTION_RPC = 0x400D04,//OK
SET_ENTITY_CAN_BE_DAMAGED = 0x1C25008,//OK
SET_ENTITY_CAN_BE_DAMAGED_RPC = 0x3B2888,//OK
GLOBALPTR = 0x1E70370,//OK
PlayerNameLocal = 0x41143344,//0x41143344//OK
PlayerNameActual = 0x0200255C,//0x200255C//OK
GET_MODEL_DIMENSIONS_FUNC = 0x9D9830,//OK
Superman2 = 0x1E459E4,//OK
SuperPunch2 = 0x1CFB0A0,//OK
OffTheRadarPointer = 0x1E70394,//OK
OffTheRadarGap = 0x22284,//OK
BullsharkGap = 0x24C18,//OK
BipassObj = 0x3F8B84,//OK
Viotureneig = 0x498B30,//OK
SkyColor = 0x4937C4,//OK
TunablePointer = 0x1E70374;//OK

//IS_PLAYER_ONLINE_RETURN = 0x2242720;
//0x2242320-0xE20
/*
IS_PLAYER_DEAD = 0x1C1B920,
IS_PLAYER_DEAD_RPC = 0x422190,
*/
...
enum TunbleIndex
{
	FAKE_BAD_SPORT_START = 120,
	FAKE_BAD_SPORT_END = 129,
	FAKE_FREE_SHOPPING_START = 60,
	FAKE_FREE_SHOPPING_END = 70,
	CHEAT_THRESHOLD_NOTCHEATER = 4,
	CHEAT_RESET_MINUTES = 5,
	KILL_DEATH_CHEAT_THRESH = 71,
	BADSPORT_THRESHOLD_NOTCHEATER = 81,
	AMOUNT_TO_FORGIVE_BADSPORT_BY = 83,
	BADSPORT_RESET_MINUTES = 82,
	IDLEKICK_WARNING1 = 74,
	IDLEKICK_WARNING2 = 75,
	IDLEKICK_WARNING3 = 76,
	TURN_ON_VALENTINES_EVENT = 4828,
	TOGGLE_ACTIVATE_INDEPENDENCE_PACK = 6004,
	Toggle_activate_Western_sovereign = 6017,
	Toggle_activate_Monster_truck = 6018,
	INDEPENDENCE_DAY_DEACTIVATE_FIREWORKS_LAUNCHER = 6012,
	TURN_SNOW_ON_OFF = 4716,
	TOGGLE_XMAS_CONTENT = 4725,
	DISABLE_SNOWBALLS = 6881,
	DISABLE_CHRISTMAS_TREE_PERISHING_SQUARE_SNOW = 6882,
	DISABLE_CHRISTMAS_TREE_PERISHING_SQUARE = 6883,
	DISABLE_CHRISTMAS_TREE_APARTMENT = 6884,
	DISABLE_CHRISTMAS_CLOTHING = 6885,
	DISABLE_CHRISTMAS_MASKS = 6886,
	DISABLE_CHRISTMAS_VEHICLES = 6887,
	toggle_gift_to_player_when_logging_on = 6844,
	TOGGLE_CHRISTMAS_EVE_GIFT = 6936,
	TOGGLE_NEW_YEARS_EVE_GIFT = 6937,
	TOGGLE_NEW_YEARS_DAY_GIFT = 6938
};
